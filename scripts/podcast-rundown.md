...
**What changed since this was first built (Jul 5):** Monday Jul 6 the Dow closed above 53,000 for the first time ever (**53,055.91, +155.84 / +0.29%**) while the chips that got crushed **snapped back** (Micron +3.5% to ~$1,009 · Broadcom +4.8% · Nasdaq +1.12% to 26,121 · S&P +0.72% to 7,537) on Foxconn's stronger-than-expected AI-driven quarterly sales; Samsung reports Tue (expected ~18× profit jump). The rotation now has a third act — washout → record → snapback — and the episode is better for it. The chart-read co-ep records tomorrow (Wed) before the 2pm minutes.
